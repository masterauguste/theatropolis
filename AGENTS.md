...
- Master state dir: `/var/lib/theatropolis/master` (`identities.json`, `deployments/`, `web-auth.json`, `web-sessions.json`, `update-request.json`, `outbound-pool.json`).
